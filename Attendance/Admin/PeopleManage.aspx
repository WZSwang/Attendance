    ...
    <div class="templatemo-content-widget no-padding">
        <div class="panel panel-default table-responsive">
            <asp:GridView ID="gdvinfo" CssClass="table table-striped table-bordered templatemo-user-table gdvinfo" runat="server" AutoGenerateColumns="False" AllowSorting="True"
                AllowPaging="True" OnRowDataBound="gdvinfo_RowDataBound" OnSorting="gdvinfo_Sorting" OnPageIndexChanging="gdvinfo_PageIndexChanging" Style="text-align: center" AllowCustomPaging="True">
                <EmptyDataTemplate>
